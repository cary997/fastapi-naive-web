...
import { testLdapResault, testLdapSettingsApi } from "@/api/test/testApi"
...
const testSuccessData = ref<testLdapResault>({
    username: null,
    nickname: null,
    email: null,
    phone: null,
...
const handleTestClick = async () => {
    ...
    await testLdapSettingsApi(testConfig, usernmae)
        .then(res => {
            if (res.code) {
                testStatus.value = 1
            }
