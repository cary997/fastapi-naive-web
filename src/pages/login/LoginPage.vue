<!--
 * @Author: guoyl
 * @Date: 2023-01-03 01:48:36
 * @LastEditors: Cary
 * @LastEditTime: 2024-02-29 06:12:57
 * @FilePath: /fastapi-naive-web/src/pages/login/LoginPage.vue
 * @Descripttion: 
-->
<template>
    ...
    <NGridItem span="0 m:2">
      <div class="flex h-screen flex-col items-center justify-center">
        <n-image
          ...
          class="animate-pulse"
        />
        <h2 class="text-center text-6xl font-normal">
          {{ logintitle }}
        </h2>
      </div>
    </NGridItem>
    <NGridItem span="4 m:2">
      <div class="flex flex-col h-screen space-y-16 default-bg">
        ...
        >
          ...
          <div class="flex-none flex flex-col w-3/4 s:w-7/12 m:w-5/12">
            <NForm
              v-show="pageType == 1"
              ref="formRef"
              :model="formModel"
