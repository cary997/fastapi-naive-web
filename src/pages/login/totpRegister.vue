<!--
 * @Author: Cary
 * @Date: 2024-02-27 23:51:45
 * @LastEditors: Cary
 * @LastEditTime: 2024-02-29 03:21:20
 * @FilePath: /fastapi-naive-web/src/pages/login/totpRegister.vue
 * @Descripttion: 
-->
<template>
  <div class="flex-1 flex flex-col space-y-6">
    ...
    <div class="flex-1 flex flex-row">
      ...
      >
        <n-qr-code :value="codeText" error-correction-level="Q" />
      </div>
    </div>
