<!--
 * @Author: guoyaolei
 * @Date: 2024-02-07 15:46:04
 * @LastEditors: Cary
 * @LastEditTime: 2024-02-25 20:47:49
 * @FilePath: /fastapi-naive-web/src/pages/auth/roles/rolesModal.vue
 * @Descripttion: 
-->
<template>
  <n-modal
    ...
    >
      <template #1>
        <n-form
          ...
          label-width="auto"
        >
          <n-form-item path="name" :label="t('rolesPage.rolesFormName')">
            <n-input
              clearable
              autosize
              style="min-width: 80%"
          ...
          <n-form-item path="desc" :label="t('rolesPage.rolesFormDesc')">
            <n-input
              clearable
              autosize
              style="min-width: 80%"
