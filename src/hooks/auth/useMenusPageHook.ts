/*
 * @Author: guoyaolei
 * @Date: 2024-01-25 20:27:37
 * @LastEditors: Cary
 * @LastEditTime: 2024-02-26 16:26:06
 * @FilePath: /fastapi-naive-web/src/hooks/auth/useMenusPageHook.ts
 * @Descripttion:
 */
...
export const defaultKeys = [
  !menusList.value.length ? 1 : menusList.value[0].id,
];
