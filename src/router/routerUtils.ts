/*
 * @Author: guoyl
 * @Date: 2023-05-24 03:49:00
 * @LastEditors: Cary
 * @LastEditTime: 2024-02-27 23:46:33
 * @FilePath: /fastapi-naive-web/src/router/routerUtils.ts
 * @Descripttion:
 */
  ...
  arrRoutes.forEach((v: RouteRecordRaw) => {
    ...
    if (v.meta?.frameSrc) {
      ...
      const index = v?.component
        ...
        : modulesRoutesKeys.findIndex((ev) => ev.includes(v.path + "index"));
