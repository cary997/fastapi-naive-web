/*
 * @Author: guoyl
 * @Date: 2023-06-30 01:59:53
 * @LastEditors: Cary
 * @LastEditTime: 2024-02-28 10:42:48
 * @FilePath: /fastapi-naive-web/src/api/auth/UsersApi.ts
 * @Descripttion:
 */
...
export const setUsersApi = (user_id: number, data?: setUsersRequest) => {
  return http.request<setUsersResponse>("patch", `/auth/users/set/${user_id}`, {
    data,
  });
};
