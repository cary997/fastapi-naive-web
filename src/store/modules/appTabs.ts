...
/*
 * @Author: guoyl
 * @Date: 2023-06-01 19:28:49
 * @LastEditors: Cary
 * @LastEditTime: 2024-02-26 21:03:40
 * @FilePath: /fastapi-naive-web/src/store/modules/appTabs.ts
 * @Descripttion:
 */
    ...
    handleTags<T>(mode: string, value?: T | multiType): T {
      switch (mode) {
        case "push": {
          ...
          if (tagVal.tab.length === 0 && tagVal.en_tab.length === 0) return;
